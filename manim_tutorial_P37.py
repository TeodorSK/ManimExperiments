...
class PlotFunctions(GraphScene):
    ...
    def construct(self):
        ...
        func_graph=self.get_graph(self.cos,self.function_color)
        func_graph2=self.get_graph(self.sin)
...
class ExampleApproximation(GraphScene):
    ...
    def construct(self):
        ...
        # term = VectorizedPoint(3*UP)

        approx_graph = VectorizedPoint(
            self.input_to_graph_point(self.center_point, func_graph)
        )
        print(self.input_to_graph_point(self.center_point, func_graph))
